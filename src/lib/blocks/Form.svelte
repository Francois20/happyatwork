...
<section
	class="flex flex-col lg:flex-row flex-1 gap-16 px-0 lg:px-md-padding xl:px-lg-padding my-24 lg:my-40 max-w-content"
>
	...
	{#if !sentMessage}
		<form on:submit|preventDefault={sendMessage} class="px-0 md:px-md-padding lg:px-0">
			<div
				class="w-full md:min-w-[540px] md:rounded-xl shadow-xl bg-marine py-12 px-sm-padding md:px-12"
			>
				<div class="pb-4">
					<label class="font-semibold block text-light mb-2" for="name">{nameLabel}</label>
					<input
						class="block w-full disabled:cursor-not-allowed disabled:opacity-50 focus:border-blue-500 focus:ring-blue-500 text-marine border border-marine p-4 rounded-full bg-light"
						id="name"
				...
				<div class="pb-4">
					...
					<textarea
						class="block w-full disabled:cursor-not-allowed disabled:opacity-50 focus:border-blue-500 focus:ring-blue-500 text-marine border border-marine p-4 rounded-xl bg-light"
						id="message"
	...
	{:else}
		<div
			class="flex justify-center items-center w-full md:min-w-[540px] h-[662px] lg:rounded-xl shadow-xl bg-marine py-16 px-sm-padding lg:px-8"
		>
			<div
				class="flex flex-col items-center justify-center bg-light h-[380px] w-[380px] rounded-full"
			>
