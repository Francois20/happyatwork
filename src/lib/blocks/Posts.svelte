...
<section class="flex flex-col py-12 md:py-16 px-sm-padding md:px-md-padding xl:px-lg-padding">
  <FilterTabs
    items={categories}
  ...
  {#each filteredPosts as post}
    <div class="flex flex-col">
      <a href={pageName + '/' + post.seo.slug.current} class="shadow-xl mb-8 w-full aspect-[5/3] overflow-hidden rounded-xl">
        <Image 
